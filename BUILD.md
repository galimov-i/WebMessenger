...
4. Введите пароль (минимум 8 символов, включая заглавные, строчные буквы и цифры)
5. Индикатор сложности пароля покажет уровень безопасности и рекомендации
6. Если пароль слишком слабый, регистрация будет заблокирована
...
- Валидация сложности паролей (оценка сложности, блокировка слабых паролей, рекомендации по генерации)
